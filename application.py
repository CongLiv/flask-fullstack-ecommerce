...
def filter2():
    ...
    typeFilter = request.form['filtertype']

    if typeFilter == "sale":
        shirts = db.execute("SELECT * FROM shirts WHERE onSale = :type ORDER BY team ASC", type=1)
    elif typeFilter == "americas":
        shirts = db.execute("SELECT * FROM shirts WHERE continent = :type ORDER BY team ASC", type="americas")
    elif typeFilter == "africa":
        shirts = db.execute("SELECT * FROM shirts WHERE continent = :type ORDER BY team ASC", type="africa")
    elif typeFilter == "europe":
        shirts = db.execute("SELECT * FROM shirts WHERE continent = :type ORDER BY team ASC", type="europe")
    elif typeFilter == "club":
        shirts = db.execute("SELECT * FROM shirts WHERE kind = :type ORDER BY team ASC", type="club")
    elif typeFilter == "national":
        shirts = db.execute("SELECT * FROM shirts WHERE kind = :type ORDER BY team ASC", type="national")
    else:
        shirts = db.execute("SELECT * FROM shirts ORDER BY team ASC")
...
def find():
    ...
    # Select all shirts that like the search team
    shirts = db.execute("SELECT * FROM shirts WHERE team LIKE :team ORDER BY team ASC", team=team + "%")
    shirtsLen = len(shirts)
...
def logged():
    ...
    return render_template ( "account.html", msgLogin="Username or password is incorrect!")
...
def registration():
    ...
    if len( rows ) > 0:
        return render_template ( "account.html", msg="Username already exists!" )
